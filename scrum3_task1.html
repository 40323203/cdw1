...
#畫E
#下面兩個平行單元
x1, y1 = mychain.basic_rot(0, -100, 0)
x2, y2 = mychain.basic_rot(x1, y1, 0)
# 左邊四個垂直個單元
x3, y3 = mychain.basic_rot(0, -100, 90)
x4, y4 = mychain.basic_rot(x3, y3, 90)
x5, y5 = mychain.basic_rot(x4, y4, 90)
x6, y6 = mychain.basic_rot(x5, y5, 90)
#中間一個平行單元
x7, y7 = mychain.basic_rot(x4, y4, 0)
# 上方兩個平行單元
x8, y8 = mychain.basic_rot(x6, y6, 0)
x9, y9 = mychain.basic_rot(x8, y8, 0)
 

#畫F
#左邊四個垂直個單元
x1, y1 = mychain.basic_rot(65, -100, 90)
x2, y2 = mychain.basic_rot(x1, y1, 90)
x3, y3 = mychain.basic_rot(x2, y2, 90)
x4, y4 = mychain.basic_rot(x3, y3, 90)
#上方兩個平行單元
x5, y5 = mychain.basic_rot(x4, y4, 0)
x6, y6 = mychain.basic_rot(x5, y5, 0)
#中間一個平行單元
x7, y7 = mychain.basic_rot(x2, y2, 0)
